...
public class BillTest {
    ...
    LocalDateTime start4 =LocalDateTime.of(2019,7,21,8,45);
    LocalDateTime end4 =LocalDateTime.of(2019,7,21,9,15);
...
//    }
    ...
    void checkPricingHolidays(){
        double price = 30.0;
        assertEquals(price,bill3.giveHolidaysPrice());
    }
    @Test
    void checkPricingInRushHour(){
        double price = 30.0;
        assertEquals(30.0,bill2.givePriceRushHour());
    }
    @Test
    void checkPricingMethod(){
        double expected = 60.0;
        assertEquals(expected, bill1.givePriceOrdinary());
    }
    @Test
    void checkPricingForDifferentTimes(){
        double expected = 45.0;
        expected = ( 15 * 2 ) + 15 * 1 ;
        assertEquals(expected,bill4.countPriceForWeekDays());
    }
    @Test
    void checkPricingForDifferent2(){
        ...
        assertEquals(expected,bill5.countPriceForWeekDays());
    }
}
